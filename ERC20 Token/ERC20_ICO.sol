...
// The Token Contract
contract AbinavMoto is ERC20Interface{
    string public name = "AbinavMoto";
    string public symbol = "MOTO";
...
contract AbinavMotoICO is AbinavMoto{
   ...
   receive () payable external{
    ...
    function transfer(address to, uint tokens) public override returns (bool success){
        ...
        super.transfer(to, tokens);  // same as AbinavMoto.transfer(to, tokens);
        return true;
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success){
        ...
        AbinavMoto.transferFrom(from, to, tokens);  // same as super.transferFrom(to, tokens);
        return true;
